...
#include "main.h"
#include "calc_EKF_F_optimized_terminate.h"
#include "calc_EKF_F_optimized_initialize.h"

// Function Declarations
static double argInit_real_T();
static void main_calc_EKF_F_optimized();
...
static void main_calc_EKF_F_optimized()
{
  ...
  // Initialize function 'calc_EKF_F_optimized' input arguments.
  qLx = argInit_real_T();
  qLy = argInit_real_T();
  qLz = argInit_real_T();
  rx = argInit_real_T();
  ...
  // Call the entry-point 'calc_EKF_F_optimized'.
  calc_EKF_F_optimized(qLx, qLy, qLz, rx, ry, rz, vx, vy, vz, Omegax, Omegay,
                       ...
                       argInit_real_T(), argInit_real_T(), argInit_real_T(),
                       argInit_real_T(), argInit_real_T(), argInit_real_T(),
                       argInit_real_T(), argInit_real_T(), argInit_real_T(), F);
}
