...
#include "main.h"
#include "calc_EKF_H_imu_optimized_simple_terminate.h"
#include "calc_EKF_H_imu_optimized_simple_initialize.h"

// Function Declarations
static double argInit_real_T();
static void main_calc_EKF_H_imu_optimized_simple();
...
static void main_calc_EKF_H_imu_optimized_simple()
{
  ...
  // Initialize function 'calc_EKF_H_imu_optimized_simple' input arguments.
  qLx = argInit_real_T();
  qLy = argInit_real_T();
  qLz = argInit_real_T();
  rx = argInit_real_T();
  ...
  // Call the entry-point 'calc_EKF_H_imu_optimized_simple'.
  calc_EKF_H_imu_optimized_simple(qLx, qLy, qLz, rx, ry, rz, vx, vy, vz, Omegax,
    ...
    argInit_real_T(), argInit_real_T(), argInit_real_T(), argInit_real_T(),
    argInit_real_T(), argInit_real_T(), argInit_real_T(), argInit_real_T(), Himu);
}
...
int main(int, const char * const [])
{
  ...
  calc_EKF_H_imu_optimized_simple_initialize();

  // Invoke the entry-point functions.
  // You can call entry-point functions multiple times.
  main_calc_EKF_H_imu_optimized_simple();

  // Terminate the application.
  // You do not need to do this more than one time.
  calc_EKF_H_imu_optimized_simple_terminate();
  return 0;
}
