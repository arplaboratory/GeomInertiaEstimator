...
// File: calc_EKF_H_odom_optimized_simple.h
//
// MATLAB Coder version            : 3.4
// C/C++ source code generated on  : 26-Feb-2019 22:48:03
//
#ifndef CALC_EKF_H_ODOM_OPTIMIZED_SIMPLE_H
#define CALC_EKF_H_ODOM_OPTIMIZED_SIMPLE_H
...
#include "rtwtypes.h"
#include "calc_EKF_H_odom_optimized_simple_types.h"

// Function Declarations
extern void calc_EKF_H_odom_optimized_simple(double qLx, double qLy, double qLz,
  ...
  t_GeomImuZ, double w, double l, double c, double k_f, double Hodom[90]);

#endif

//
// File trailer for calc_EKF_H_odom_optimized_simple.h
//
// [EOF]
//
