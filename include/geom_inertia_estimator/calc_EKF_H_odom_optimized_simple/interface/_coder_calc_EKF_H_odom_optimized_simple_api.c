 ...
 * File: _coder_calc_EKF_H_odom_optimized_simple_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "calc_EKF_H_odom_optimized_simple",  /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
 ...
 * Return Type  : void
 */
void calc_EKF_H_odom_optimized_simple_api(const mxArray * const prhs[40], const
  mxArray *plhs[1])
{
  real_T (*Hodom)[90];
  real_T qLx;
  ...
  Hodom = (real_T (*)[90])mxMalloc(sizeof(real_T [90]));
  ...
  plhs[0] = emlrt_marshallOut(*Hodom);
}
 ...
 * Return Type  : void
 */
void calc_EKF_H_odom_optimized_simple_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  calc_EKF_H_odom_optimized_simple_xil_terminate();
}
 ...
 * Return Type  : void
 */
void calc_EKF_H_odom_optimized_simple_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void calc_EKF_H_odom_optimized_simple_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_calc_EKF_H_odom_optimized_simple_api.c
 *
 * [EOF]
 */
