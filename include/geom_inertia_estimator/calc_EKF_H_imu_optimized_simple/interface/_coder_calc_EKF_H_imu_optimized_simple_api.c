 ...
 * File: _coder_calc_EKF_H_imu_optimized_simple_api.c
 *
...
#include "_coder_calc_EKF_H_imu_optimized_simple_mex.h"
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "calc_EKF_H_imu_optimized_simple",   /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static const mxArray *emlrt_marshallOut(const real_T u[90])
{
  ...
  static const int32_T iv1[2] = { 3, 30 };
 ...
 * Return Type  : void
 */
void calc_EKF_H_imu_optimized_simple_api(const mxArray * const prhs[40], const
  mxArray *plhs[1])
{
  real_T (*Himu)[90];
  real_T qLx;
  ...
  Himu = (real_T (*)[90])mxMalloc(sizeof(real_T [90]));
  ...
  calc_EKF_H_imu_optimized_simple(qLx, qLy, qLz, rx, ry, rz, vx, vy, vz, Omegax,
    ...
    ImuBiasAccX, ImuBiasAccY, ImuBiasAccZ, ImuBiasAngVelX, ImuBiasAngVelY,
    ImuBiasAngVelZ, motor1, motor2, motor3, motor4, dt, t_GeomImuZ, w, l, c, k_f,
    *Himu);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*Himu);
}
 ...
 * Return Type  : void
 */
void calc_EKF_H_imu_optimized_simple_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  calc_EKF_H_imu_optimized_simple_xil_terminate();
}
 ...
 * Return Type  : void
 */
void calc_EKF_H_imu_optimized_simple_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void calc_EKF_H_imu_optimized_simple_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_calc_EKF_H_imu_optimized_simple_api.c
 *
 * [EOF]
 */
